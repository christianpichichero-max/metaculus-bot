...
RESOLVED binary: 92 | Brier 0.2058 (lower=better, 0.25=coinflip) | LogLoss 0.6149

Reliability (predicted bucket vs actual yes-rate):
   0- 10% | n= 21 | actual 19%
  10- 20% | n= 24 | actual 17%
...
OFFICIAL scores captured on 164 question(s): SPOT PEER total = -538.13 (prize share ∝ max(0, total)²)
...
BLF SHADOW A/B (48 resolved):
  submitted (ensemble geo-odds) Brier: 0.2048
  belief-loop (shadow)          Brier: 0.2422  ← ensemble better/tied
